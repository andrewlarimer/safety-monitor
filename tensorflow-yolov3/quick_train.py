...
DECAY_RATE       = 0.9
SHUFFLE_SIZE     = 200
CLASSES          = utils.read_coco_names('./construction_dataset/construction.names')
ANCHORS          = utils.get_anchors('./construction_dataset/construction_anchors.txt', IMAGE_H, IMAGE_W)
NUM_CLASSES      = len(CLASSES)
EVAL_INTERNAL    = 100
SAVE_INTERNAL    = 500

train_tfrecord   = "./construction_dataset/construction_train.tfrecords"
test_tfrecord    = "./construction_dataset/construction_dev.tfrecords"
