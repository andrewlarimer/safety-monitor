...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset_txt", type=str, default="./construction_dataset/construction_train.txt")
    parser.add_argument("--anchors_txt", type=str, default="./construction_dataset/construction_anchors.txt")
